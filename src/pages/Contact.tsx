    ...
    return (
      <div className="pt-40 pb-32 px-6 min-h-screen bg-white dark:bg-[#050505] flex items-center justify-center transition-colors">
        <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium">Your audit request has been received. Our operations center will reach out within 24 hours.</p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div className="space-y-12">
            <h1 className="text-6xl font-black text-black dark:text-white uppercase tracking-tighter">Initiate Audit.</h1>
          ...
          <div className="bg-gray-50 dark:bg-[#0a0a0b] border border-gray-100 dark:border-white/5 p-10 md:p-12 relative shadow-sm dark:shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-8">
              <input required name="name" value={formData.name} onChange={handleInputChange} className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white font-bold outline-none focus:border-[#00adef]" placeholder="Operator Name" />
              <input required name="email" value={formData.email} onChange={handleInputChange} type="email" className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white font-bold outline-none focus:border-[#00adef]" placeholder="Work Email" />
              <textarea required name="briefing" value={formData.briefing} onChange={handleInputChange} rows={4} className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white resize-none font-medium outline-none focus:border-[#00adef]" placeholder="Security Briefing..." />
              <div onClick={() => fileInputRef.current?.click()} className="border-2 border-dashed border-gray-200 dark:border-white/10 p-10 text-center cursor-pointer hover:border-[#00adef] transition-colors">
