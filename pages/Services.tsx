...
const Services: React.FC = () => {
  ...
  return (
    <div className="pt-32 pb-40 px-6 min-h-screen bg-white dark:bg-[#050505] transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="mb-32">
          <p className="text-[#00adef] font-black text-xs uppercase tracking-[0.3em] mb-6">CAPABILITIES</p>
          <h1 className="text-6xl md:text-7xl font-black text-black dark:text-white leading-none tracking-tighter mb-10">
            Precision Security <br />
            <span className="text-gray-400 dark:text-gray-500">for Modern Systems.</span>
          </h1>
              ...
              >
                <div className="flex-1 space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                    <div>
                      <h4 className="text-black dark:text-white text-[10px] font-black uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                        TECHNICAL FOCUS
                        <div className="flex-grow h-px bg-gray-100 dark:bg-white/10"></div>
                      </h4>
                      <ul className="space-y-4">
                        {service.outcomes.map((outcome) => (
                          <li key={outcome} className="flex items-start gap-3 text-gray-500 dark:text-gray-400 text-sm font-medium">
                    ...
                    <div>
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3 text-gray-500 dark:text-gray-400 text-sm font-medium">
                ...
                <div className="flex-1 w-full lg:w-1/2">
                  <div className="relative aspect-[16/10] overflow-hidden rounded-sm border border-gray-100 dark:border-white/5 shadow-xl">
                    <img 
                      src={image} 
                      alt={service.title} 
                      className="w-full h-full object-cover opacity-90 dark:opacity-60 transition-all duration-1000 grayscale hover:grayscale-0"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-[#050505] via-transparent to-transparent opacity-40 transition-opacity"></div>
                  </div>
                </div>
              </div>
            );
