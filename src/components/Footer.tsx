      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <img src={LOGO_URL} alt="EagleEye Logo" className="h-10 w-auto brightness-100" />
            ...
            <div className="pt-2">
              <button 
                ...
                className="bg-[#00adef] hover:bg-[#33beff] text-black px-6 py-3 rounded-sm text-[10px] font-black uppercase tracking-widest transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2 shadow-[0_10px_30px_rgba(0,173,239,0.3)]"
              >
          ...
          <div>
            <h4 className="text-white font-black mb-6 text-sm uppercase tracking-widest">Solutions</h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 border-t border-white/5 gap-6">
          <p className="text-gray-500 text-xs font-bold">
            © 2026 EagleEye Cyber Technologies, LLC. All Rights Reserved.
          </p>
          <div className="flex gap-6 text-gray-500 text-xs uppercase font-bold">
