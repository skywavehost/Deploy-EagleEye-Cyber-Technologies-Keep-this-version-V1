      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 space-y-6">
          ...
          <p className="text-xl text-gray-500 dark:text-gray-400 max-w-3xl mx-auto font-light leading-relaxed">
            We are looking for elite minds to defend global digital infrastructure. At EagleEye, you aren't just an employee; you are a sentinel.
          </p>
        </div>

        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-2xl font-black text-black dark:text-white uppercase mb-8 border-l-4 border-[#00adef] pl-4 tracking-tight">Active Missions</h2>
          {JOB_OPENINGS.map((job) => (
            <div 
              key={job.id} 
              className={`group p-8 border border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#0a0a0b] cursor-pointer hover:border-[#00adef]/40 transition-all relative overflow-hidden ${
            ...
            >
              ...
              {selectedJobId === job.id && (
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-white/10 animate-in fade-in slide-in-from-top-2 duration-300 relative z-10">
                  ...
                  <button 
                    ...
                    className="bg-[#00adef] text-white dark:text-black px-8 py-3 rounded-sm text-xs font-black uppercase tracking-widest hover:bg-[#33beff] transition-all shadow-[0_0_20px_rgba(0,173,239,0.2)]"
                  >
                    Apply Now
                  </button>
                </div>
                  ...
                  <div className="lg:col-span-3 p-8 md:p-12 relative overflow-hidden">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <input required name="name" value={formData.name} onChange={handleInputChange} className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white font-bold outline-none focus:border-[#00adef]" placeholder="Full Name" />
                        <input required name="email" value={formData.email} onChange={handleInputChange} type="email" className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white font-bold outline-none focus:border-[#00adef]" placeholder="Email" />
                      </div>
                      ...
                      <textarea required name="statement" value={formData.statement} onChange={handleInputChange} rows={4} className="w-full bg-white dark:bg-black border border-gray-200 dark:border-white/10 p-4 text-black dark:text-white resize-none font-medium outline-none focus:border-[#00adef]" placeholder="Candidate Statement" />
                      <button type="submit" className="w-full bg-[#00adef] text-white dark:text-black py-5 font-black uppercase text-sm shadow-xl hover:bg-[#33beff] transition-all">Submit Application</button>
                    </form>
                  </div>
                </div>
              )}
